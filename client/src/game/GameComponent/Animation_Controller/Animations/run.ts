...
export class RunForwardAnimation {
    isAdaptive = false;
    start(
...
export class RunBackwardAnimation {
    isAdaptive = false;
    start(
        initialBodyPartPositions: initialBodyPartPositions,
        bodyParts: BodyPart,
    ...
    update(
        ...
        bodyParts.head.rotation = PhaserMath.DegToRad(3);
        ...
        bodyParts.main_body.rotation = PhaserMath.DegToRad(-3);
    }
    end(bodyParts: BodyPart) {
        bodyParts.main_body.rotation = 0;
        bodyParts.head.rotation = 0;
